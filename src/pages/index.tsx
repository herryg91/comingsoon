...
const HomePage: NextPage = () => {
  ...
  <div className="w-full max-w-3xl mx-auto min-h-screen py-12 text-center px-4 flex">
    ...
    <section id="header" className="">
      ...
      <Badge className="my-4 bg-accent text-gray-700">Coderbased is coming soon</Badge>
      <h1 className={"max-w-xl text-5xl mx-auto font-bold " + font_bricolage.className}>Live Coding Interview Platform</h1>
      <p className="text-lg font-light mt-4">Real coding environment for live coding interview</p>
    </section>
